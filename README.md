<h1 align="center">Hey, I'm Lokman 👋</h1>
<h3 align="center">Aspiring Fullstack Developer · Malaysia</h3>

<p align="center">
  Final-year IT student at OUM & Product Development Technician at TF-AMD Microelectronics.<br/>
  Transitioning into software engineering — I build fullstack apps with real auth, databases, and CI/CD, not just CRUD tutorials.
</p>

<p align="center">
  <a href="https://lokmankhodziri.vercel.app/">Portfolio</a> ·
  <a href="https://github.com/LokmanKhodziri">GitHub</a> ·
  <a href="https://www.linkedin.com/in/lokmankhodziri/">LinkedIn</a> ·
  <a href="mailto:lokmankhodziri@gmail.com">Email</a>
</p>
...
**Backend**  
`Node.js` `Express` `NestJS` `Spring Boot` `Laravel`

**Database & Infra**  
`PostgreSQL` `MySQL` `MongoDB` `Prisma` `Redis` `Docker` `GitHub Actions` `Jenkins` `Linux`
...
- 🏗 Shipping portfolio work — [Musafir-Go](https://github.com/LokmanKhodziri/travel-planner-web), MySME Ops, and [CariPart](https://github.com/LokmanKhodziri/techpricing_insights)
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white)](https://github.com/LokmanKhodziri)
[![Portfolio](https://img.shields.io/badge/Portfolio-000?style=flat&logo=vercel&logoColor=white)](https://lokmankhodziri.vercel.app/)
